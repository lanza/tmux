...
am__append_2 = -O2
#am__append_3 = -O0
am__append_4 = -g -Wno-long-long -Wall -W \
	-Wformat=2 -Wno-use-after-free \
	-Wmissing-prototypes \
	-Wstrict-prototypes \
...
am__dist_tmux_SOURCES_DIST = alerts.c arguments.c attributes.c cfg.c \
	...
	tty-term.c tty.c utf8-combined.c utf8.c window-buffer.c \
	window-client.c window-clock.c window-copy.c \
	window-customize.c window-tree.c window.c xmalloc.c xmalloc.h \
	image.c image-sixel.c
...
dist_tmux_OBJECTS = alerts.$(OBJEXT) arguments.$(OBJEXT) \
	...
	window-customize.$(OBJEXT) window-tree.$(OBJEXT) \
...
ACLOCAL = ${SHELL} /home/lanza/Projects/tmux/etc/missing aclocal-1.16
AMTAR = $${TAR-tar}
...
AM_CPPFLAGS = -D_DEFAULT_SOURCE -D_XOPEN_SOURCE=600     \
	-DTMUX_VERSION='"next-3.7"' -DTMUX_GIT_HASH='"$(shell git -C \
	$(srcdir) rev-parse --short HEAD 2>/dev/null || echo \
	unknown)"' \
	-DTMUX_CONF='"$(sysconfdir)/tmux.conf:~/.tmux.conf:$$XDG_CONFIG_HOME/tmux/tmux.conf:~/.config/tmux/tmux.conf"' \
	-DTMUX_LOCK_CMD='"vlock"' \
	-DTMUX_TERM='"tmux-256color"' $(am__append_6) $(am__append_7) \
	$(am__append_8) $(am__append_9) $(am__append_11) \
	$(am__append_12) $(am__append_13) $(am__append_14)
AM_DEFAULT_VERBOSITY = 1
AM_LDFLAGS = 
AUTOCONF = ${SHELL} /home/lanza/Projects/tmux/etc/missing autoconf
AUTOHEADER = ${SHELL} /home/lanza/Projects/tmux/etc/missing autoheader
AUTOMAKE = ${SHELL} /home/lanza/Projects/tmux/etc/missing automake-1.16
AWK = gawk
CC = gcc
...
LIBNCURSES_CFLAGS = 
LIBNCURSES_LIBS = 
LIBOBJS =  ${LIBOBJDIR}fgetln$U.o ${LIBOBJDIR}freezero$U.o ${LIBOBJDIR}getdtablecount$U.o ${LIBOBJDIR}getpeereid$U.o ${LIBOBJDIR}getprogname$U.o ${LIBOBJDIR}htonll$U.o ${LIBOBJDIR}ntohll$U.o ${LIBOBJDIR}setproctitle$U.o ${LIBOBJDIR}strlcat$U.o ${LIBOBJDIR}strlcpy$U.o ${LIBOBJDIR}strtonum$U.o ${LIBOBJDIR}recallocarray$U.o ${LIBOBJDIR}getopt_long$U.o ${LIBOBJDIR}imsg$U.o ${LIBOBJDIR}imsg-buffer$U.o ${LIBOBJDIR}vis$U.o ${LIBOBJDIR}unvis$U.o ${LIBOBJDIR}fdforkpty$U.o
LIBS = -ltinfo  -levent_core  -lm  -lresolv
LIBTINFO_CFLAGS = -D_DEFAULT_SOURCE -D_XOPEN_SOURCE=600 
LIBTINFO_LIBS = -ltinfo 
LIBUTF8PROC_CFLAGS = 
LIBUTF8PROC_LIBS = 
LTLIBOBJS =  ${LIBOBJDIR}fgetln$U.lo ${LIBOBJDIR}freezero$U.lo ${LIBOBJDIR}getdtablecount$U.lo ${LIBOBJDIR}getpeereid$U.lo ${LIBOBJDIR}getprogname$U.lo ${LIBOBJDIR}htonll$U.lo ${LIBOBJDIR}ntohll$U.lo ${LIBOBJDIR}setproctitle$U.lo ${LIBOBJDIR}strlcat$U.lo ${LIBOBJDIR}strlcpy$U.lo ${LIBOBJDIR}strtonum$U.lo ${LIBOBJDIR}recallocarray$U.lo ${LIBOBJDIR}getopt_long$U.lo ${LIBOBJDIR}imsg$U.lo ${LIBOBJDIR}imsg-buffer$U.lo ${LIBOBJDIR}vis$U.lo ${LIBOBJDIR}unvis$U.lo ${LIBOBJDIR}fdforkpty$U.lo
MAKEINFO = ${SHELL} /home/lanza/Projects/tmux/etc/missing makeinfo
MANFORMAT = mdoc
...
YACC = bison -y
YFLAGS = 
abs_builddir = /home/lanza/Projects/tmux
abs_srcdir = /home/lanza/Projects/tmux
abs_top_builddir = /home/lanza/Projects/tmux
abs_top_srcdir = /home/lanza/Projects/tmux
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/lanza/Projects/tmux/etc/install-sh
...
dist_tmux_SOURCES = alerts.c arguments.c attributes.c cfg.c client.c \
	...
	window-customize.c window-tree.c window.c xmalloc.c xmalloc.h \
	$(am__append_18)
nodist_tmux_SOURCES = osdep-linux.c $(am__append_15) \
...
mostlyclean-generic:
	...
	-rm -f compat/getopt_long.$(OBJEXT)
